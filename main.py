...
from app.api import users, sessions, dimensions, utterances_and_feedback, memory_and_interests, voice
...
async def lifespan(app: FastAPI):
    ...
    """
    # Запуск: инициализация БД (временно отключено для отладки)
    try:
        await init_db()
