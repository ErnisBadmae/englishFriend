...
## English Friend Stack Specifics
...
- **Migrations**: Flyway-style SQL in `db/migrations/postgres/` (000-007)
...
# Good pattern - eager loading relationships
...
- Optimizing database queries or partition strategies
- Designing new microservices or sync consumers
...
- Clear requirements (user explicitly asks for specific implementation)
