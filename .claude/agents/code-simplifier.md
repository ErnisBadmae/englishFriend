...
description: Code simplification specialist. Use proactively after significant code changes to simplify and improve readability without changing functionality.
