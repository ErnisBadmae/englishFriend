...
- **Коллега - ключевой разработчик** - его SQL миграции являются источником истины
- SQLAlchemy модели строго синхронизированы с миграциями
- FastAPI использует существующую схему БД без изменений
- Интеграционные тесты проверяют совместимость моделей с SQL схемой
- Автоматическая синхронизация с Qdrant (sync-vector) и Neo4j (sync-graph) через CDC

Подробности: 
- [INTEGRATION.md](INTEGRATION.md) - общая интеграция
- [SYNC_WITH_COLLEAGUE.md](SYNC_WITH_COLLEAGUE.md) - синхронизация с архитектурой коллеги
